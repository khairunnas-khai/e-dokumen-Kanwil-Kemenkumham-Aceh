        ...
        <nav class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">E-Documents <span class="logo-dec"></span></a>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="banner-info text-center wow fadeIn delay-05s">
              ...
              <div class="logo">
		            <img src="img/kemenkumham.png" alt="" />
	            </div>
              <h3 class="bnr-sub-title">E-DOCUMENTS</h3>
                <h3 class="bnr-sub-title"><span class="logo-dec">KEMENKUMHAM RI KANWIL ACEH</span></h3>
            </div>
          </div>
        </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="sub-title pad-bt15">Website ini berguna untuk pengarsipan Dokumen</p> di lingkungan perkantoran kemenkumham RI Aceh</p>
            <hr class="bottom-line">
            <p class="sub-title pad-bt15">Pengarsipan Data<strong> PENTING</strong></p>
            <hr class="bottom-line">
          </div>
        <div class="col-md-4">
        </div>
          ...
          <div class="col-md-2 col-sm-6 col-xs-12">
            <div class="wrap-item text-center">
              ...
              <h3 class="pad-bt15">File Data</h3>
            </div>
          </div>
        <div class="col-md-4">
        </div>
    ...
    <footer id="footer">
      <div class="container">
        <div class="row text-center">
          <p>&copy; Teknik Komputer USK - Khairunnas. &copy; 2021 All Rights Reserved.</p>
          <div class="credits">
            <!-- 
