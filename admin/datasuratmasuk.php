          ...
          <div class="">
            <div class="page-title">
              <div class="title_right">
                <h2>Dokumen > <small>Data Dokumen</small></h2>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <button type="submit" class="btn btn-success"><i class="fa fa-download"></i> Unduh Laporan Dokumen</button></a>
                  <a href="inputsuratmasuk.php"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Dokumen</button></a>
                  </form>
                  <div class="x_content">
                  <div class="x_content">
                              <?php
